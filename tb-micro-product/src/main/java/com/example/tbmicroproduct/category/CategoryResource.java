...
public class CategoryResource {
    ...
    public ResponseEntity createCategory(@RequestBody Category category, @RequestParam String session) {
        if (isAdmin(session)) {
    ...
    public void updateCategory(@RequestBody Category category, @PathVariable String id, @RequestParam String session) {
        if (isAdmin(session)) {
